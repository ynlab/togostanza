...
gem 'togostanza', github: 'ynlab/togostanza-gem'
...
# gem 'refgs_dev_stanza', path: './refgs_dev_stanza'
# gem 'refgs_dev2_stanza', path: './refgs_dev2_stanza'
gem 'genome_projects_stanza', path: './genome_projects_stanza'
gem 'external_links_stanza', path: './external_links_stanza'
gem 'taxonomy_stanza', path: './taxonomy_stanza'
